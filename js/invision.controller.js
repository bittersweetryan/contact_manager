...
!(function( InVision, $, undefined ){
	...
	InVision.Controller = function( application, apiRoot ){	
		// I am the application which oversees all of the controllers.
		this.application = application;
		
		// I am the API root for AJAX requests.
		...
		// I am a flag that determines if the controller will be responsive to user input.
		// The Application can turn this flag on / off to make the view act appropriately.
